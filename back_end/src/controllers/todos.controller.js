...
const getUserIdFromToken = (req) => {
    ...
    const decoded = jsonwebtoken.verify(token, process.env.JWT_SECRET || 'secret_key');
    return decoded.id;
};
...
module.exports = { getAlltodos, gettodoById, createtodo, updatetodo, deletetodo, getAlltodosPagination, gettodoByIdUserAllData, getAlltodosByState, gettodoByUserId };
